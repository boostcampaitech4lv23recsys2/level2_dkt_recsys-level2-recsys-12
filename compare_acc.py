...
def compare_acc(COMPARE_PATH="SequenceModel/output/lastquery_ensemble-aw_hidden_dim256.csv"):
    threshold = 0.5
    ...
    compare["prediction"] = compare["prediction"].apply(lambda x: 1 if x > threshold else 0)
