...
def main():
    ...
    test_user_feature_engineering, test_item_feature_engineering, = prepare_dataset(
        device,
        CFG.basepath,
    ...
    model = build(
        ...
        user_test_n_node, 
        user_tag_n_node,
        num_user_feature=len(test_user_feature_engineering.T),
        num_item_feature=len(test_item_feature_engineering.T),
        model_type=2,
